#
# zircon_led_driver.tcl
#

# Create a new driver
create_driver zircon_led

# Associate it with some hardware known as "zircon_led"
set_sw_property hw_class_name zircon_led
...
#
add_sw_property c_source HAL/src/zircon_led.c

# Include files
add_sw_property include_source HAL/inc/zircon_led.h
add_sw_property include_source inc/zircon_led_regs.h
