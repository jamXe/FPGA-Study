...
# Create a new driver
create_driver zircon_avalon_vga

# Associate it with some hardware known as " zircon_segled"
set_sw_property hw_class_name  zircon_avalon_vga
...
#
add_sw_property c_source HAL/src/zircon_avalon_vga.c

# Include files
add_sw_property include_source HAL/inc/zircon_avalon_vga.h
add_sw_property include_source inc/zircon_avalon_vga_regs.h
add_sw_property include_source HAL/inc/Andy_Warhol.h
