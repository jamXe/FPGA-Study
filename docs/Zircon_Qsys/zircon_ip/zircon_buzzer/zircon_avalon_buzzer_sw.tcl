#
# zircon_buzzer_driver.tcl
#

# Create a new driver
create_driver zircon_avalon_buzzer

# Associate it with some hardware known as "zircon_buzzer"
set_sw_property hw_class_name zircon_avalon_buzzer
...
#
add_sw_property c_source HAL/src/zircon_avalon_buzzer.c

# Include files
add_sw_property include_source HAL/inc/zircon_avalon_buzzer.h
add_sw_property include_source inc/zircon_avalon_buzzer_regs.h
