...
`define BIT_0_LOW		 24'h6E5A   // 0.565ms @ 50MHz, standard is 24'h6E5A

`define BIT_1_HIGH	 24'h6D60   // 0.560ms @ 50MHz, standard is 24'h6D60
`define BIT_1_LOW		 24'h1_4A14 // 1.685ms @ 50MHz, standard is 24'h1_4A14
...
//high_time 为红外引导码9ms低电平，(high_time[23:14] == `HEAD_HIGH) 
//24'h6_DDD0 = (0110_11)01_1101_1101_0000 的[23:14]是(01_1011) = 10'h1B
//1B+14个0=6C000 X 20ns = 8.85ms
`define HEAD_HIGH 	 10'h1B		//(0110_11)01_1101_1101_0000 约 8.85ms
`define HEAD_LOW		 10'hD		//(0011_01)10_1110_1110_1000 约 4.26ms
`define BIT_0_HIGH	 10'h1		//(0000_01)10_1101_0110_0000 约 0.33ms
`define BIT_0_LOW		 10'h1		//(0000_01)10_1110_0101_1010 约 0.33ms
`define BIT_0_LOW2	 10'h2		//(0000_10)00_0000_0000_0000 约 0.66ms
`define BIT_1_HIGH	 10'h1		//(0000_01)10_1101_0110_0000 约 0.33ms
`define BIT_1_LOW		 10'h5		//(0001_01)00_1010_0001_0100 约 1.64ms
`define BIT_1_LOW2	 10'h4		//(0001_00)00_0000_0000_0000 约 1.31ms                       
`define REP_HEAD_HIGH 10'h1B		//(0110_11)01_1101_1101_0000 约 8.85ms
`define REP_HEAD_LOW	 10'h7		//(0001_10)11_0111_0111_0100 约 1.97ms
`define REP_BIT_HIGH	 10'h1		//(0000_01)10_1101_0110_0000 约 0.33ms
`define REP_BIT_LOW	 10'h37		//(1111_01)00_0010_0100_0000 约19.99ms

module zircon_avalon_ir_logic
(
	//输入端口
...
//组合电路,状态机进入串行接收状态触发中断
always @ (*)
begin
	if(ir_fsm_ns == FSM_DATA)				//判断状态机的状态
		irq_n = 1'b1;							//状态机进入串行接收状态触发中断
	else
		irq_n = 1'b0;							//否则清除中断
end
