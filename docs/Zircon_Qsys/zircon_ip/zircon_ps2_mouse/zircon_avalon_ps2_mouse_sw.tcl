#
# zircon_ps2_mouse_driver.tcl
#

# Create a new driver
create_driver zircon_avalon_ps2_mouse

# Associate it with some hardware known as "zircon_ps2_mouse"
set_sw_property hw_class_name zircon_avalon_ps2_mouse
...
#
add_sw_property c_source HAL/src/zircon_avalon_ps2_mouse.c

# Include files
add_sw_property include_source HAL/inc/zircon_avalon_ps2_mouse.h
add_sw_property include_source inc/zircon_avalon_ps2_mouse_regs.h
