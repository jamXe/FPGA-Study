#
# zircon_ps2_keyboard_driver.tcl
#

# Create a new driver
create_driver zircon_avalon_ps2_keyboard

# Associate it with some hardware known as "zircon_ps2_keyboard"
set_sw_property hw_class_name zircon_avalon_ps2_keyboard
...
#
add_sw_property c_source HAL/src/zircon_avalon_ps2_keyboard.c

# Include files
add_sw_property include_source HAL/inc/zircon_avalon_ps2_keyboard.h
add_sw_property include_source inc/zircon_avalon_ps2_keyboard_regs.h
