#
#  zircon_tlc5615_driver.tcl
#

# Create a new driver
create_driver zircon_avalon_tlc5615

# Associate it with some hardware known as " zircon_tlc5615"
set_sw_property hw_class_name  zircon_avalon_tlc5615
...
#
add_sw_property c_source HAL/src/zircon_avalon_tlc5615.c

# Include files
add_sw_property include_source HAL/inc/zircon_avalon_tlc5615.h
add_sw_property include_source inc/zircon_avalon_tlc5615_regs.h
